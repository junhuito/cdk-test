...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const stackName = (0, utils_1.requireEnv)('STACK_NAME');
            const functionVersionToRetain = Number(process.env.RETAIN_FUNCTION_VERSION);
            const layerVersionToRetain = Number(process.env.RETAIN_LAYER_VERSION);
